...
export const tableData = [
    ...
    //             text: 'Opening and Keynote' 
    //         },
    //         {
    //             time: '10:30',
    //             icon: '/assets/talk-icon.svg',
    //             text: 'Masterclasses Slot 1' 
    //         },
    //         {
    //             time: '12:00',
    //             icon: '/assets/talk-icon.svg',
    //             text: 'Masterclasses Slot 2' 
    //         },
    //         {
    //             time: '01:15',
    ...
    //             time: '02:00',
    //             icon: '/assets/clip.svg',
    //             text: 'Learning Debrief' 
    //         },
    //         {
    //             time: '02:30',
    //             icon: '/assets/talk-icon.svg',
    //             text: 'Design Workshop - Part 1' 
    //         },
    //         {
    //             time: '04:00',
    //             icon: '/assets/tea-break.svg',
        ...
        tableDetails: [
            {
                time: '09:00',
                icon: '/assets/hand-wave.svg',
                text: 'Registration and Networking',
                descriptionDetails: []
            },
            {
                time: '10:00',
            ...
            },
            {
                time: '11:00',
                icon: '/assets/talk-icon.svg',
                // text: 'Hackathon - Part 1' 
                text: 'Parallel Spaces' ,
                descriptionDetails: [
                    {
                        title: 'Hackathon',
                    ...
                    },
                    {
                        ...
                        description: 'Equity and Reinvention: At-Odds or Ad-vantage'
                    },
                    {
                ...
                descriptionDetails: [
                    {
                        ...
                        description: 'Unconference format to design prototypes in a rapid and collaborative manner, culminating into a community pitchathon. (Part 2)'
                    },
                    {
                        title: 'Panel Discussion 3',
                        description: 'Disruptions through AI: Impact on Learners'
                    },
                    {
            ...
            },
            {
                ...
                descriptionDetails: [
                    {
                        title: 'Student Workshop by Riverside',
                        description: null
                    },
                    {
                        title: 'Conference of The Birds Workshop by Shaheen Mistri and students',
                        description: null
                    },
                ]
            },
