...
export default function HeroBannerText() {
  ...
  return (
    <div className="text-[#FBFAED] leading-[4rem] sm:leading-none w-full relative bottom-[8%] h-fit">
      <p className={`${textClassName} relative lg:top-0 sm:left-0 sm:top-[-20%] md:top-6 lg:left-1 w-fit`}>
        The future
      </p>
      <p className={`${textClassName} grid sm:relative sm:top-6 3xl:top-0`}>
        <span className="">of education is</span>
      </p>
      <p className={`${textClassName} relative sm:bottom-0`}>
        here.
      </p>
